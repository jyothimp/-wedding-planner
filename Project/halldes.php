...
$item_id=0;
  ...
  if(isset($_POST['hall_edit_submit'])){
    ...
    $result = mysqli_query($con, "SELECT * FROM `wp_addtocart` WHERE `hall_id`=$item_id `hall_status`=1") or die(mysqli_error($con));
  }
  ?>
      ...
      <div class="col-sm-12">
        <div class="elements-section" id="accordion">
          <div class="headline style-1">
            <div>
              <h2><center>Hall Description</center></h2>
              <?php
                  ...
                  <div class="col-lg-12" >
                    ...
                    <div class="col-lg-6">
											<table style="width:100%;border;" class="desc_table">
												...
												<tr>
													<th>Description</th>
													<td><?php echo $row['hall_description'] ?></td>
												</tr>
												<tr>
													<th>Price</th>
