...
$item_id=0;
  ...
  if(isset($_POST['food_edit_submit'])){
    ...
    $result = mysqli_query($con, "SELECT * FROM `wp_addtocart` WHERE `food_id`=$item_id `food_status`=1") or die(mysqli_error($con));
  }
  ?>
<!doctype html>
<html>
      ...
      <div class="col-sm-12">
        <div class="elements-section" id="accordion">
          <div class="headline style-1">
            <div>
              <h2><center>food Description</center></h2>
              <?php
              $query=mysqli_query($con,"SELECT * FROM `wp_food` WHERE `food_id`=$item_id");
              while ($row=mysqli_fetch_array($query)) {
                ?>
                <form action="./catservice.php" method="post">
                  <div class="col-lg-12" >
                    <div class="col-lg-6">
