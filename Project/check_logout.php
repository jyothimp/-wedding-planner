...
if(!isset($_SESSION['user'])){
  ...
  if($role==1){
    if(!($page=="payment.php"|$page=="cart.php"||$page=="payment.php"||$page=="design-stage.php"||$page=="design-decor.php"||$page=="catservice.php"||$page=="get-a-quote.php"||$page=="stagedes.php"||$page=="halldes.php"||$page=="fooddes.php")){
