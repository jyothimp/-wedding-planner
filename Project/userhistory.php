...
<head>
	...
	<meta name="description" content="At present there are various trends include in the weddings. Angel wedding company provides the facility of the beach wedding that makes your day as much special. Contact us : info.angelweddings@gmail.com, +91 99464 90001">
	<meta name="author" content="Invosome">
	<title>Beach Weddings in Kochi | Angel Wedding Company</title>
			...
			<style>
				...
				<div class="content">
					...
					<div class="container">
                        ...
                        <div class="col-sm-12">
                          <b style="font-size:18px"> Completed Orders</b>
      										<div class="portfolio-item-description"><br>
                        ...
                        <div class="col-sm-12"><br><br>
                          <b style="font-size:18px"> Canceled Orders</b>
                          <div class="portfolio-item-description"><br>
                            <table class="cart_table" align="center" width="200" border="1">
                              <tr><font color="black">
                                <th class="col-sm-2">Item</th>
                              ...
                              <?php
                              $total=0;
                              $query=mysqli_query($con,"select cart_id,cart_login_id,cart_item_id,cart_item_type,sum(cart_quantity) AS quantity,item_name,item_id from wp_addtocart,wp_item_types where wp_addtocart.cart_item_type=wp_item_types.item_id and cart_login_id=$user_id and cart_status=0 and order_status=0 GROUP BY cart_item_id");
                              while ($row=mysqli_fetch_array($query)) {
                                $item_type = $row['cart_item_type'];
                                $item_id = $row['cart_item_id'];
                                if($item_type==1){
