...
<html>
 ...
 <head>
    ...
    <meta name="keywords" content="Invitation Designing in Kochi,Invitation Designing in Kerala,Wedding Invitation Designing in Kochi,Invitation Designing in Kochi Kerala,Wedding Planner in Kochi">
    <meta name="description" content="Scenario Weddings partners provide you the services of invitation card designing, which is the primary part of the wedding. We have the best wedding card designers to give you the unique designs. Contact us : scenariowedding@gmail.com, +91 99464 90001">
    <meta name="author" content="Innovosome">
    <title>Invitation Designing in Kochi | Scenario Wedding Planner </title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <p>As a professional WEDDING PLANNER our services start from the unique designing of the wedding invitation that will furnish the warmth of love your heart extends to your valued invitees and reflect the dignity and honour they render to us with their presence and blessings all together during the celebrations.</p>
            ...
            <!--<div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <h3>The Eco-friendly Invites</h3>
                        
                        <p>A trend that is catching up these days is the eco-friendly wedding invitation. Eco-friendly wedding invitations are designed on special paper that can be recycled. The wedding planners at Scenario Weddings always try to minimize the strain on the environment by encouraging the use of e-cards or e-invitations for weddings. </p>
                        
                    </div>
                    <div class="col-sm-6">
                    	
                        <h3>Invitation Videos</h3>
                        
                        <p>A wedding invitation can also be substituted by wedding invitation videos which are in the form of 1 minute or 2 minute teasers, inviting the guests to the wedding function. These wedding videos can be made into humourous and lively representations of the couple and their life stories, giving the invited guest a reason to smile.
<br>

The wedding planning team of Scenario Weddings has their own in-house invitation design unit who script and design wedding invitations. This wedding invitation designing unit make customized wedding invitations, differing from client to client. </p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h3>Designer Wedding Invitation Models:</h3>
                        
                        <p>Scenario Weddings work with the best card designers to give you unique designs. You can also personalise the design according to your taste and requirement.</p>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="about-me wow fadeInLeft animated" style="visibility: visible;">
                        	
                            <div class="about-me-thumbnail">
                            	
                                <img src="scenario_webmaster/upload/invitation/614614950.jpg" alt="Wedding videography in Kochi">
                    ...
                    <!-- col -->
                        ...
                        <div class="about-me wow fadeInLeft animated" style="visibility: visible;">
                            ...
                            <div class="about-me-thumbnail">
                                ...
                                <img src="scenario_webmaster/upload/invitation/1034059006.jpg" alt="Wedding videography in Kochi">
                    ...
                    <!-- col -->
                        ...
                        <div class="about-me wow fadeInLeft animated" style="visibility: visible;">
                            ...
                            <div class="about-me-thumbnail">
                                ...
                                <img src="scenario_webmaster/upload/invitation/1805115941.jpg" alt="Wedding videography in Kochi">
                    ...
                    <!-- col -->
                        ...
                        <div class="about-me wow fadeInLeft animated" style="visibility: visible;">
                            ...
                            <div class="about-me-thumbnail">
                                ...
                                <img src="scenario_webmaster/upload/invitation/441782648.jpg" alt="Wedding videography in Kochi">
                    ...
                    <!-- col -->
                        ...
                        <div class="about-me wow fadeInLeft animated" style="visibility: visible;">
                            ...
                            <div class="about-me-thumbnail">
                                ...
                                <img src="scenario_webmaster/upload/invitation/1811492547.jpg" alt="Wedding videography in Kochi">
                    ...
                    <!-- col -->
                        ...
                        <div class="about-me wow fadeInLeft animated" style="visibility: visible;">
                            ...
                            <div class="about-me-thumbnail">
                                ...
                                <img src="scenario_webmaster/upload/invitation/1599807878.jpg" alt="Wedding videography in Kochi">
                    ...
                    <!-- col -->
                        ...
                        <div class="about-me wow fadeInLeft animated" style="visibility: visible;">
                            ...
                            <div class="about-me-thumbnail">
                                ...
                                <img src="scenario_webmaster/upload/invitation/1523128382.jpg" alt="Wedding videography in Kochi">
                    ...
                    <!-- col -->
                        ...
                        <div class="about-me wow fadeInLeft animated" style="visibility: visible;">
                            ...
                            <div class="about-me-thumbnail">
                                ...
                                <img src="scenario_webmaster/upload/invitation/1520515538.jpg" alt="Wedding videography in Kochi">
                    ...
                    <!--<p class="innerp">These are a few glimpses of the marvellous wedding invitation cards we have in store for you. To custom order invites like these, mail Scenario Weddings at <a href="#">mail@scenario.co.in.</a></p> --><!-- col -->
                ...
                <!--<div class="col-sm-12">
                        ...
                        <p>Luxury wedding invitations with jewels and other handiworks can also be ordered through Scenario Weddings.</p>
                        
                        
                                <img src="images/about/team/image-4.jpg" alt="">
                                
                                <br>
<br>

                                <h4>Online Invitations</h4>
                                <p>Luxury wedding invitations with jewels and other handiworks can also be ordered through Scenario Weddings.</p>
