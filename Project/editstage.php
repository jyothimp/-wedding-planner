...
if(isset($_POST['stage_edit_submit'])){
  $item_id=$_POST['item_id'];
  if(isset($_POST['stage_image'])){
  $imagename = $_POST['stage_image'];
}
//Stores the filename as it was on the client computer.
	...
	$result = mysqli_query($con, "update wp_stage set stage_name='$stage_name',stage_image='$imagename',stage_description='$stage_description',stage_price='$stage_price')where  item_id=$item_id");
}
?>
<!doctype html>
<html>
