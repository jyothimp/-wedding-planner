...
if(isset($_POST['hall_edit_submit'])){
  ...
  $result = mysqli_query($con, "update wp_hall set hall_name='$hall_name',hall_image='$imagename',hall_description='$hall_description',hall_price='$hall_price' where  hall_id=$item_id") or die(mysqli_error($con));
}
?>
<!doctype html>
<html>
