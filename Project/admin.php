...
<html>
 ...
 <head>
    ...
    <title>Destination Weddings in Kochi Kerala | Scenario </title>
...
<body>
   ...
   <style>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                       ...
                       <div class="col-sm-6">
                        <p>Destination wedding travellers seek Kerala to enjoy a peaceful getaway from the hustle and bustle of the fast-paced city life. Destination weddings are designed to give the guests an out-of-the-world experience. A destination wedding is a mix of a rejuvenating vacation and a wedding celebration. Often, destination weddings are held at cultural spots such as palaces and forts. Close family and kin are flown in from across the world for the destination wedding and are treated to a royal party, lasting a few days, in an exotic location.  </p>
                        </div>

                        <div class="col-sm-6">
                        <p>Destination weddings in Kerala occur mainly in the central districts of the state – Kochi, Alappuzha, Kottayam – to mention a few wedding destinations. Beach weddings, bay water weddings, palace weddings happen at many destinations in Kerala. We can make these destination weddings a lavish ceremony, clubbed with special incentives for sight-seeing in Kerala.</p>
                        </div>
                    </div><!-- col -->
                </div><!-- row -->
            </div><!-- container -->
            ...
            <div class="container">
                <p>Here are some of the best destination wedding venues in Kerala :
</p>
            	<div class="row">
                	<div class="col-sm-12">
                            ...
                            <div class="row">
                            	<div class="col-sm-4">
                                    ...
                                    <div class="portfolio-item-thumbnail">
                                        ...
                                        <img src="scenario_webmaster/upload/destinationweddings/792289536.jpg" alt="which is the number one wedding company in kerala">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="portfolio-item-description">
                                        ...
                                        <h3><a href="destinationwedding.php">Alapuzha</a></h3>

                                        <p><p>Alleppey is one of the most important tourist centers in the state, with a large network of inland canals earning it the sobriquet&nbsp;<strong>&ldquo;Venice of the east&rdquo; .</strong>These large network of canals provide Alleppey its lifeline. Alleppey was one of the busiest centers of trade in the past with one of the best known ports along the MalabarCoast.</p>
<p><span lang="EN-IN">&nbsp;</span></p></p>

                                        <a class="btn btn-default" href="destinationwedding.php?id=5&venue=3">Know more</a>
                            ...
                            <div class="row">
                            	<div class="col-sm-4">
                                    ...
                                    <div class="portfolio-item-thumbnail">
                                        ...
                                        <img src="scenario_webmaster/upload/destinationweddings/1367157347.jpg" alt="which is the number one wedding company in kerala">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="portfolio-item-description">
                                        ...
                                        <h3><a href="destinationwedding.php">Munnar</a></h3>

                                        <p><p>Munnar is situated at the confluence of three mountain streams - Mudrapuzha, Nallathanni and Kundala. 1600 m above sea level, this hill station was once the summer resort of the erstwhile British Government in South India. Sprawling tea plantations, picture book towns, winding lanes and holiday facilities make this a popular resort town and an ideal destination for a destination wedding.</p>
<p><span lang="EN-IN">&nbsp;</span></p></p>

                                        <a class="btn btn-default" href="destinationwedding.php?id=6&venue=4">Know more</a>
                            ...
                            <div class="row">
                            	<div class="col-sm-4">
                                    ...
                                    <div class="portfolio-item-thumbnail">
                                        ...
                                        <img src="scenario_webmaster/upload/destinationweddings/1174164933.jpg" alt="which is the number one wedding company in kerala">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="portfolio-item-description">
                                        ...
                                        <h3><a href="destinationwedding.php">Wayanad</a></h3>

                                        <p><p><span lang="EN-IN">The flat and open region of the eastern region is a dream location for any destination wedding. We make all the arrangements for you to conduct your dream wedding there.</span></p></p>

                                        <a class="btn btn-default" href="destinationwedding.php?id=7&venue=5">Know more</a>
