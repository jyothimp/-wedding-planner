...
if(isset($_POST['photo_edit_submit'])){
  ...
  $result = mysqli_query($con, "update wp_photo set photo_name='$photo_name',photo_image='$imagename',photo_address='$photo_address',photo_website='$photo_website',photo_pin='$photo_pin',photo_phone='$photo_phone',photo_email='$photo_email' where  photo_id=$item_id") or die(mysqli_error($con));
}
?>
<!doctype html>
<html>
