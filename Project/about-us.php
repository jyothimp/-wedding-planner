            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <center><img class="wow pulse" src="images/backgrounds/bg-8.jpg" alt="Wedding planner in Kochi" width="1000" height="400" h></center>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h3>How does an Indian Wedding Planner help you</h3>

                <div class="row">

                     <div class="col-sm-6">

                     <p class="aboutus">EVENTS are ultimate celebrations with us . The ambience of exclusiveness we create make it as your signature. Everybody may cherish those as very personal moments with you for the rest of their life. The venue and the theme would never be seen as the same to feel its lively presence further again other than in their memories. BE it an emotional and personal event of your life or any other get-together parties with those who mattered OR a dramatic launching of a commercial venture /product presenting to an elite group of dignified people or prospective customers.</p>

                    </div><!-- col -->

                     <div class="col-sm-6">

                     <p class="aboutus">TODAY we have many joyful families and organization in our proud list of clientèle who are content and enjoy being part of a concept that truly cares and shares. OUR bouquet of several pioneering packages and services has enabled many to fulfil their aspirations beyond their expectations.</p>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="headline style-3">
                            ...
                            <h5>ANGEL</h5>
                            <h2>Meet our team</h2>
                            <p class="aboutus">OUR TEAM consists of high end professionals specialised in visualising ,fine arts, engineering and management  to meet every needs of the situations involve in recreating a 'make believe' atmosphere where glorious moments take shape as a catalyst of masterminds.<br>
BE it a traditional theme or the most advanced cyber start up.</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <p class="aboutus">WEDDINGS, product launches,award nights and fashion shows.........what ever may be the occasions , we have  classic ideas to be remained in the minds of participants and guests with the real essence of the theme , for ever.OUR expertise may provide you the inputs to organise the event from the scratch to the final execution like the prepartion of the invitation letters to the final end of the event by standing at your side of thoughts and actions. SOMETIMES enticing and sometimes elusive for others..</p>
